...
<MARQUEE direction="up" style="font-size: 40px;">요기어때? 야보자</marquee>
<body>
...
<marquee style="font-size: 60px; font-family: '야놀자 야체 B'">요기어때? 야보자</marquee>
...
<marquee style="font-size: 40px;">요기어때? 야보자</marquee>
<MARQUEE direction="up" style="font-size: 40px;">요기어때? 야보자</marquee>
</body>
</html>